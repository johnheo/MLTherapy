...
Both file inside "rpi" folder are supposed to run on the raspberrypi.
File "index.html" inside "jsfolder" folder is suppose to run on one's browser on a laptop with webcam. 
